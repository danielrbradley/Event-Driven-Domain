namespace EventDrivenDomain.EventStore
{
    ...
    public struct Hash
    {
        ...
        /// <summary>
        /// Determines whether the specified <see cref="T:EventDrivenDomain.EventStore.Hash"/> is equal to the current <see cref="T:EventDrivenDomain.EventStore.Hash"/>.
        /// </summary>
        /// <returns>
        ...
        /// <summary>
        /// Determines whether the specified <see cref="T:System.Array"/> is equal to the current <see cref="T:EventDrivenDomain.EventStore.Hash"/>.
        /// </summary>
        /// <returns>
        /// true if the specified object  is equal to the current object; otherwise, false.
        /// </returns>
